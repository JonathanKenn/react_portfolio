...
const HomePage = () => {
  return (
    <div className="home min-h-screen px-12 py-6 lg:px-20" id="home">
      ...
      <div className="mx-auto mt-20 max-w-xl text-center lg:mt-24">
        ...
        <h1 className="mb-12 mt-4 bg-gradient-to-r from-secondary to-gradient bg-clip-text text-5xl font-semibold leading-[1.1] text-transparent lg:text-7xl">
