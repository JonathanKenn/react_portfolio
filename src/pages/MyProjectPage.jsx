...
const MyprojectPage = () => {
  ...
  return (
    <div className="dark:bg-secondary dark:text-primary">
        ...
        <div className="mx-auto mb-14 mt-10">
          <div className="text-center lg:top-20">
            <div className="flex justify-between">
              ...
              <Link
                to="/"
                className="flex items-center rounded-2xl px-3 transition-all hover:bg-secondary hover:text-primary dark:hover:bg-primary dark:hover:text-secondary"
              >
